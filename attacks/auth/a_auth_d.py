"""Phase 7 concrete attack for auth boundary, STRIDE letter D (Denial of Service).
...
class AuthDAttack(Attack):
    """STRIDE row for the auth boundary, letter D (Denial of Service).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the auth/D attack and return the result."""
