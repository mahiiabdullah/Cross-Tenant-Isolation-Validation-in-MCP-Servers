"""Phase 7 concrete attack for auth boundary, STRIDE letter E (Elevation of Privilege).
...
class AuthEAttack(Attack):
    """STRIDE row for the auth boundary, letter E (Elevation of Privilege).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the auth/E attack and return the result."""
