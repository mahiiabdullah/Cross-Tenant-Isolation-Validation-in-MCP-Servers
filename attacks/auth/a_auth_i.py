"""Phase 7 concrete attack for auth boundary, STRIDE letter I (Information Disclosure).
...
class AuthIAttack(Attack):
    """STRIDE row for the auth boundary, letter I (Information Disclosure).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the auth/I attack and return the result."""
