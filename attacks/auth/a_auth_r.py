"""Phase 7 concrete attack for auth boundary, STRIDE letter R (Repudiation).
...
class AuthRAttack(Attack):
    """STRIDE row for the auth boundary, letter R (Repudiation).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:H``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the auth/R attack and return the result."""
