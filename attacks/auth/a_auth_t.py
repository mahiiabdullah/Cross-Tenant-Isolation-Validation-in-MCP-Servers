"""Phase 7 concrete attack for auth boundary, STRIDE letter T (Tampering).
...
class AuthTAttack(Attack):
    """STRIDE row for the auth boundary, letter T (Tampering).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the auth/T attack and return the result."""
