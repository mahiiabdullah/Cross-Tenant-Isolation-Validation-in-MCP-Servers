"""Phase 7 concrete attack for cache boundary, STRIDE letter D (Denial of Service).
...
class CacheDAttack(Attack):
    """STRIDE row for the cache boundary, letter D (Denial of Service).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the cache/D attack and return the result."""
