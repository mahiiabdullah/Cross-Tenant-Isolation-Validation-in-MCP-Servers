"""Phase 7 concrete attack for cache boundary, STRIDE letter E (Elevation of Privilege).
...
class CacheEAttack(Attack):
    """STRIDE row for the cache boundary, letter E (Elevation of Privilege).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the cache/E attack and return the result."""
