"""Phase 7 concrete attack for cache boundary, STRIDE letter R (Repudiation).
...
class CacheRAttack(Attack):
    """STRIDE row for the cache boundary, letter R (Repudiation).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the cache/R attack and return the result."""
