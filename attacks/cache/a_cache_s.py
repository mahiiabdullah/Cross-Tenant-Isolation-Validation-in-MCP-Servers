"""Phase 7 concrete attack for cache boundary, STRIDE letter S (Spoofing).
...
class CacheSAttack(Attack):
    """STRIDE row for the cache boundary, letter S (Spoofing).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the cache/S attack and return the result."""
