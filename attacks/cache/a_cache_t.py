"""Phase 7 concrete attack for cache boundary, STRIDE letter T (Tampering).
...
class CacheTAttack(Attack):
    """STRIDE row for the cache boundary, letter T (Tampering).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the cache/T attack and return the result."""
