"""Phase 7 concrete attack for memory boundary, STRIDE letter D (Denial of Service).
...
class MemoryDAttack(Attack):
    """STRIDE row for the memory boundary, letter D (Denial of Service).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the memory/D attack and return the result."""
