"""Phase 7 concrete attack for memory boundary, STRIDE letter E (Elevation of Privilege).
...
class MemoryEAttack(Attack):
    """STRIDE row for the memory boundary, letter E (Elevation of Privilege).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the memory/E attack and return the result."""
