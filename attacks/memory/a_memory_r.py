"""Phase 7 concrete attack for memory boundary, STRIDE letter R (Repudiation).
...
class MemoryRAttack(Attack):
    """STRIDE row for the memory boundary, letter R (Repudiation).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the memory/R attack and return the result."""
