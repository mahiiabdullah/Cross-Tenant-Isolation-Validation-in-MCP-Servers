"""Phase 7 concrete attack for memory boundary, STRIDE letter S (Spoofing).
...
class MemorySAttack(Attack):
    """STRIDE row for the memory boundary, letter S (Spoofing).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the memory/S attack and return the result."""
