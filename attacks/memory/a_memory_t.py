"""Phase 7 concrete attack for memory boundary, STRIDE letter T (Tampering).
...
class MemoryTAttack(Attack):
    """STRIDE row for the memory boundary, letter T (Tampering).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the memory/T attack and return the result."""
