"""Phase 7 concrete attack for namespace boundary, STRIDE letter E (Elevation of Privilege).
...
class NamespaceEAttack(Attack):
    """STRIDE row for the namespace boundary, letter E (Elevation of Privilege).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the namespace/E attack and return the result."""
