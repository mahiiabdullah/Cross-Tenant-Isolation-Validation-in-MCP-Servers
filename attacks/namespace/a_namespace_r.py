"""Phase 7 concrete attack for namespace boundary, STRIDE letter R (Repudiation).
...
class NamespaceRAttack(Attack):
    """STRIDE row for the namespace boundary, letter R (Repudiation).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the namespace/R attack and return the result."""
