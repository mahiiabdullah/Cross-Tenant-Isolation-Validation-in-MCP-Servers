"""Phase 7 concrete attack for namespace boundary, STRIDE letter S (Spoofing).
...
class NamespaceSAttack(Attack):
    """STRIDE row for the namespace boundary, letter S (Spoofing).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the namespace/S attack and return the result."""
