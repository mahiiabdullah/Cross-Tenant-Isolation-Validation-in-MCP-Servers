"""Phase 7 concrete attack for namespace boundary, STRIDE letter T (Tampering).
...
class NamespaceTAttack(Attack):
    """STRIDE row for the namespace boundary, letter T (Tampering).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the namespace/T attack and return the result."""
