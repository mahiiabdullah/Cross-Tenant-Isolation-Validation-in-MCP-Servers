"""Phase 7 concrete attack for resources boundary, STRIDE letter E (Elevation of Privilege).
...
class ResourceEAttack(Attack):
    """STRIDE row for the resources boundary, letter E (Elevation of Privilege).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the resources/E attack and return the result."""
