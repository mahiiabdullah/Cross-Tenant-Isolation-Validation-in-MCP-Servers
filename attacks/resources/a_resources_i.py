"""Phase 7 concrete attack for resources boundary, STRIDE letter I (Information Disclosure).
...
class ResourceIAttack(Attack):
    """STRIDE row for the resources boundary, letter I (Information Disclosure).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the resources/I attack and return the result."""
