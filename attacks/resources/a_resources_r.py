"""Phase 7 concrete attack for resources boundary, STRIDE letter R (Repudiation).
...
class ResourceRAttack(Attack):
    """STRIDE row for the resources boundary, letter R (Repudiation).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the resources/R attack and return the result."""
