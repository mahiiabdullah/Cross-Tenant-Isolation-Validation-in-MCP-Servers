"""Phase 7 concrete attack for resources boundary, STRIDE letter S (Spoofing).
...
class ResourceSAttack(Attack):
    """STRIDE row for the resources boundary, letter S (Spoofing).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the resources/S attack and return the result."""
