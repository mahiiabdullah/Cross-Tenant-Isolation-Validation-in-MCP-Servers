"""Phase 7 concrete attack for resources boundary, STRIDE letter T (Tampering).
...
class ResourceTAttack(Attack):
    """STRIDE row for the resources boundary, letter T (Tampering).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the resources/T attack and return the result."""
