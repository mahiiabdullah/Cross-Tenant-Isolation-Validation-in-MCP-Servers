"""Phase 7 concrete attack for session boundary, STRIDE letter E (Elevation of Privilege).
...
class SessionEAttack(Attack):
    """STRIDE row for the session boundary, letter E (Elevation of Privilege).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the session/E attack and return the result."""
