"""Phase 7 concrete attack for session boundary, STRIDE letter I (Information Disclosure).
...
class SessionIAttack(Attack):
    """STRIDE row for the session boundary, letter I (Information Disclosure).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the session/I attack and return the result."""
