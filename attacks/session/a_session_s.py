"""Phase 7 concrete attack for session boundary, STRIDE letter S (Spoofing).
...
class SessionSAttack(Attack):
    """STRIDE row for the session boundary, letter S (Spoofing).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:N``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the session/S attack and return the result."""
