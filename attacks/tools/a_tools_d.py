"""Phase 7 concrete attack for tools boundary, STRIDE letter D (Denial of Service).

Pattern: :func:`attacks._patterns.tools_attack` (specialised by STRIDE).

CVSS:3.1 vector: ``CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:U/C:N/I:N/A:H``
...
class ToolDAttack(Attack):
    """STRIDE row for the tools boundary, letter D (Denial of Service).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:U/C:N/I:N/A:H``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the tools/D attack and return the result."""
