"""Phase 7 concrete attack for tools boundary, STRIDE letter E (Elevation of Privilege).
...
class ToolEAttack(Attack):
    """STRIDE row for the tools boundary, letter E (Elevation of Privilege).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:U/C:H/I:H/A:H``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the tools/E attack and return the result."""
