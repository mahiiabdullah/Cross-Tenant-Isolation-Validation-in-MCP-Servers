"""Phase 7 concrete attack for tools boundary, STRIDE letter I (Information Disclosure).
...
class ToolIAttack(Attack):
    """STRIDE row for the tools boundary, letter I (Information Disclosure).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:U/C:H/I:N/A:N``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the tools/I attack and return the result."""
