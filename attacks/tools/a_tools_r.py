"""Phase 7 concrete attack for tools boundary, STRIDE letter R (Repudiation).
...
class ToolRAttack(Attack):
    """STRIDE row for the tools boundary, letter R (Repudiation).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:U/C:N/I:H/A:N``
    """

    id = "A-TOL-R"
    boundary = Boundary.TOOL
    cvss = "CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:U/C:N/I:H/A:N"
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the tools/R attack and return the result."""
