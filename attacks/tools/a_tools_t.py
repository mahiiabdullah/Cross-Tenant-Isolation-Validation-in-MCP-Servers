"""Phase 7 concrete attack for tools boundary, STRIDE letter T (Tampering).
...
class ToolTAttack(Attack):
    """STRIDE row for the tools boundary, letter T (Tampering).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the tools/T attack and return the result."""
