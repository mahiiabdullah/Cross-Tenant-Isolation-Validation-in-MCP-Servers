"""Phase 7 concrete attack for transport boundary, STRIDE letter D (Denial of Service).
...
class TransportDAttack(Attack):
    """STRIDE row for the transport boundary, letter D (Denial of Service).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the transport/D attack and return the result."""
