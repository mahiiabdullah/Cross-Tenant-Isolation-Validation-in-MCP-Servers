"""Phase 7 concrete attack for transport boundary, STRIDE letter E (Elevation of Privilege).
...
class TransportEAttack(Attack):
    """STRIDE row for the transport boundary, letter E (Elevation of Privilege).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the transport/E attack and return the result."""
