"""Phase 7 concrete attack for transport boundary, STRIDE letter R (Repudiation).
...
class TransportRAttack(Attack):
    """STRIDE row for the transport boundary, letter R (Repudiation).

    CVSS:3.1: ``CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N``
    """
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the transport/R attack and return the result."""
