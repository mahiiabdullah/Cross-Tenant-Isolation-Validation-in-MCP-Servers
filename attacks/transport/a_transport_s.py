"""Phase 7 concrete attack for transport boundary, STRIDE letter S (Spoofing).
...
class TransportSAttack(Attack):
    """STRIDE row for the transport boundary, letter S (Spoofing).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the transport/S attack and return the result."""
