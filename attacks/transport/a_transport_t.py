"""Phase 7 concrete attack for transport boundary, STRIDE letter T (Tampering).
...
class TransportTAttack(Attack):
    """STRIDE row for the transport boundary, letter T (Tampering).
    ...
    async def execute(self, ctx: AttackContext) -> AttackResult:
        """Run the transport/T attack and return the result."""
