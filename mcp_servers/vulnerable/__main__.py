"""Run the vulnerable server on stdio for manual smoke-testing."""
...
def main() -> int:
    ...
    server = build_server()
    logger.info("vulnerable server ready; send newline-delimited JSON-RPC envelopes on stdin")
    for line in sys.stdin:
        ...
        if method == "tools/list":
            ...
            tenant = params.get("__tenant__", "tenant-A")
            result = server.call_tool_as(tenant, name, arguments)
