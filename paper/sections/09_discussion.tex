...
this protocol. The reviewer-simulation step
critiques the experimental design and the statistical
protocol; we address the critique in \S\ref{sec:discussion}.